...
const Header = () => {
	...
	const overlayClass = isCartSidebar ? "overlay open" : "overlay";
	const cartSidebarClass = isCartSidebar ? "cart-sidebar open" : "cart-sidebar";
	isCartSidebar ? (document.body.style.overflowY = "hidden") : (document.body.style.overflowY = "initial");
			...
			<div className="container">
				<div className="header-wrapper">
					<Link to="/" className="nav-brand">
						<img src={logoDark} width="90" alt="umino" />
					</Link>
					...
					<div className="user-info">
						...
						<Link to="login" className="user-link user">
							<svg width="17" height="17" viewBox="0 0 17 17" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
						...
						<Link to="wishlist" className="user-link wishlist">
					...
					{/* Cart Sidebar */}
					<Stack direction={"column"} alignItems={"flex-start"} className={cartSidebarClass} justifyContent={"space-between"}>
									...
									{carts.map((item) => {
										...
										return (
											<React.Fragment key={item.id}>
												<Stack direction={"row"} className="cart-products" justifyContent={"space-between"}>
													<Stack direction={"row"} justifyContent={"space-between"} className="cart-product-item">
														...
														<Stack direction={"column"} justifyContent={"center"}>
															...
															>
																...
																<Stack direction={"row"} alignItems={"center"} className="quantity-item" justifyContent={"space-around"}>
																	<div
						...
						<div className="sidebar-footer">
							...
							<Link to="cart" className="btn btn-dark" onClick={closeCartSidebar}>
								View Cart
							</Link>
						</div>
					</Stack>
