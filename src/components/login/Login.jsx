					...
					>
						<div className="form">
							...
							<form onSubmit={handleSubmit(loginHandler)}>
								...
								<input type="email" id="loginEmail" placeholder="Your email*" {...register('loginEmail', {
									required: {
										value: true,
								...
								<input type="password" id="loginPassword" placeholder="Password*" {...register('loginPassword', {
									required: {
										value: true,
